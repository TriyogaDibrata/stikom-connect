...
INSERT INTO `t_laporans` (`id`, `kategori_id`, `user_id`, `topik`, `uraian`, `status_id`, `hidden`, `created_at`, `updated_at`) VALUES
(1, 1, 4, 'Tenetur sed incidunt maiores iste vel perferendis.', 'Aut dolorum enim ullam voluptatem. Commodi totam molestiae ut ipsum. Tenetur iusto minima voluptas velit.', 1, 0, NULL, NULL),
(2, 1, 8, 'Sapiente architecto harum mollitia corporis quod eum.', 'Corporis laudantium sit cupiditate dolorem omnis vel. Dolore est tenetur voluptate pariatur natus. Eum omnis id consequatur ea voluptatem. Dignissimos blanditiis vero fuga aut quia.', 1, 1, NULL, NULL),
(3, 1, 2, 'Rem sed labore numquam non nesciunt sed.', 'Aliquid rem itaque vel veniam eveniet repellendus repellat. Impedit sed distinctio doloremque eveniet sit sint. Quas asperiores nemo assumenda vel maiores aut.', 1, 0, NULL, NULL),
(4, 1, 1, 'Voluptates et est quia laboriosam.', 'Praesentium minima et autem vel nemo et eos repellendus. Nihil reprehenderit non tenetur deserunt. Cum et unde reiciendis deserunt aliquam.', 1, 0, NULL, NULL),
(5, 1, 8, 'Dolorem alias quisquam libero quisquam beatae alias.', 'Quod et similique et ut et debitis quod. Harum excepturi voluptatem debitis unde eaque quo. Omnis rem officia corporis dicta. Recusandae id ipsa non qui possimus accusamus aliquid voluptates.', 1, 0, NULL, NULL),
(6, 1, 9, 'Placeat quae autem ratione cum.', 'Ullam corporis laborum sunt quia fugit et maxime. Aut vel quae eveniet molestias. Modi praesentium magnam ipsum beatae est non a.', 1, 1, NULL, NULL),
(7, 1, 8, 'Expedita nisi aut sint ut maxime.', 'Voluptas similique atque ratione veritatis. Repellat voluptate praesentium id commodi debitis. Quam quas temporibus consequatur.', 1, 0, NULL, NULL),
(8, 1, 9, 'Ab itaque repudiandae dolores est optio autem rerum.', 'Architecto eum distinctio asperiores incidunt et quis corporis. Praesentium ea ea et non. Excepturi quis eum optio quo. Ipsam et architecto sint ut. Beatae iste veniam ipsa commodi placeat animi est.', 1, 1, NULL, NULL),
(9, 1, 9, 'Consectetur pariatur commodi earum earum nostrum quo.', 'Id et et qui. Beatae occaecati ipsum laudantium omnis aut porro ullam. Amet omnis distinctio deleniti consectetur veritatis et architecto. Tempora dolorum iste laboriosam.', 1, 1, NULL, NULL),
(10, 1, 0, 'Sed consequatur consectetur laborum at vero.', 'Et voluptatem sit quo occaecati eveniet et. Voluptatem reiciendis excepturi rerum numquam rerum architecto. Aspernatur nostrum ratione ut et cumque iure cupiditate.', 1, 1, NULL, NULL),
(11, 1, 0, 'At cupiditate qui accusantium.', 'Praesentium nisi quidem ut eaque. Ut et sit incidunt consequatur nulla aut. Nemo eaque quisquam id sunt iure provident ut. Aut alias illum ab in rerum qui animi.', 1, 0, NULL, NULL);
